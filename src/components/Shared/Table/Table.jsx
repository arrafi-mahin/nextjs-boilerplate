                    ...
                    ({
                      ...
                      return (
                        <td
                          ...
                          key={key}
                          className={`min-w-[10rem] max-w-max py-[1.125rem] px-4 text-sm leading-5 cursor-pointer ${
                            key === "ID" ||
                            key === "StudentName" ||
                            key === "Category"
                              ? "text-blue"
                          ...
                          style={{
                            boxShadow: "0px -1px 0px 0px #E1E3E5 inset",
                          }}
                        >
